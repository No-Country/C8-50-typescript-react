	...
	return (
		<ContainerCard>
			<Card>
				...
				<Form onSubmit={handleSubmit(Submit)}>
					<Containerinput>
						...
						{errors.name?.type === 'required' && (
							<ErrorInput> Necesitas insertar tu nombre </ErrorInput>
						)}
					</Containerinput>
					<Containerinput>
						...
						{errors.email?.type === 'required' && (
							<ErrorInput> Necesitas insertar tu correo </ErrorInput>
						)}
						{errors.email?.type === 'pattern' && (
							<ErrorInput> Escribir bien el correo </ErrorInput>
						)}
					</Containerinput>
					<Containerinput>
						...
						{errors.password?.type === 'required' && (
							<ErrorInput> Necesitas insertar tu contraseña </ErrorInput>
						)}
					</Containerinput>
					<Containerinput>
						<LabelInput htmlFor='ConfirmpasswordInput'>
						...
						{errors.confirmPassword?.type === 'required' && (
							<ErrorInput> Necesitas confirmar tu contraseña </ErrorInput>
						)}
						{errors.confirmPassword?.type === 'validate' && (
							<ErrorInput> La contraseñas no coinciden </ErrorInput>
						)}
					</Containerinput>
				...
				<CambioLogin>
					{' '}
					¿ Ya tienes cuenta? <SpanCambio> iniciar sesion </SpanCambio>{' '}
				</CambioLogin>
			</Card>
		</ContainerCard>
	);
